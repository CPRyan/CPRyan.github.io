...
img: assets/img/lecturing_thumbnail.jpg
importance: 1
category: Teaching
---
...
Much of this work involves onboarding new students and analysts, including many international trainees, into the standard operating procedures of research data science. I teach workflows for reproducible analysis, transparent documentation, secure handling of sensitive data, version control, collaborative coding, quality control, and robust project organization.
...
<figure>
  <img src="{{ 'assets/img/reproducible_research_training_habits.png' | relative_url }}" class="img-fluid rounded z-depth-1" alt="Reproducible research training habits flow chart">
  <figcaption class="caption">Training habits for reproducible, secure, and collaborative data science.</figcaption>
</figure>
